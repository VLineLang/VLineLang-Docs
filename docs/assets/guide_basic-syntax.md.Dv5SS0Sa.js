import{_ as s,c as n,o as p,ae as e}from"./chunks/framework.Dh1jimFm.js";const u=JSON.parse('{"title":"基础语法","description":"","frontmatter":{},"headers":[],"relativePath":"guide/basic-syntax.md","filePath":"guide/basic-syntax.md"}'),l={name:"guide/basic-syntax.md"};function i(t,a,c,o,r,d){return p(),n("div",null,a[0]||(a[0]=[e(`<h1 id="基础语法" tabindex="-1">基础语法 <a class="header-anchor" href="#基础语法" aria-label="Permalink to &quot;基础语法&quot;">​</a></h1><p>本章节将详细介绍VLineLang的基本语法规则。</p><div class="tip custom-block github-alert"><p class="custom-block-title">TIP</p><p>你可以使用 <code>import &quot;packageName&quot;</code> 来导入自定义模块。VLineLang具有完整的<a href="./module-system.html">模块系统</a>，支持多级目录和优先级导入。</p></div><h2 id="变量和常量" tabindex="-1">变量和常量 <a class="header-anchor" href="#变量和常量" aria-label="Permalink to &quot;变量和常量&quot;">​</a></h2><h3 id="变量声明" tabindex="-1">变量声明 <a class="header-anchor" href="#变量声明" aria-label="Permalink to &quot;变量声明&quot;">​</a></h3><p>VLineLang使用动态类型系统，变量无需显式声明类型：</p><div class="language-vline vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vline</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 数字</span></span>
...
<span class="line"><span>import &quot;StdList&quot;  /* 导入列表标准库，需要确保运行目录有此文件 */</span></span>
<span class="line"><span></span></span>
<span class="line"><span>numbers = new List()  /* 创建空列表 */</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// numbers = new List(3)  /* 创建大小为3的列表，所有初始元素元素为0 */</span></span>
<span class="line"><span>// numbers = new List(3, 1)  /* 创建大小为3的列表，所有初始元素元素为1 */</span></span>
<span class="line"><span></span></span>
<span class="line"><span>numbers.append(4)       /* 添加元素 */</span></span>
<span class="line"><span>numbers.erase(0, 1)        /* 删除指定位置 [start,end) 的元素 */</span></span>
<span class="line"><span>numbers.insert(0, 1)    /* 在指定位置插入元素 */</span></span>
<span class="line"><span>print(numbers.size())  /* 输出列表大小 */</span></span>
<span class="line"><span>print(numbers.empty())  /* 检查列表是否为空 */</span></span></code></pre></div><h2 id="运算符" tabindex="-1">运算符 <a class="header-anchor" href="#运算符" aria-label="Permalink to &quot;运算符&quot;">​</a></h2><h3 id="算术运算符" tabindex="-1">算术运算符 <a class="header-anchor" href="#算术运算符" aria-label="Permalink to &quot;算术运算符&quot;">​</a></h3><div class="language-vline vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vline</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>a = 10</span></span>
...
<span class="line"><span>print(~2)   // 输出-3</span></span></code></pre></div><div class="warning custom-block github-alert"><p class="custom-block-title">WARNING</p><p>位运算符会将大数转换成<em>64位有符号整数</em>，可能会导致精度损失。</p></div><h2 id="注释" tabindex="-1">注释 <a class="header-anchor" href="#注释" aria-label="Permalink to &quot;注释&quot;">​</a></h2><p>VLineLang支持两种注释方式：</p><div class="language-vline vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vline</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 这是一个单行注释</span></span>
<span class="line"><span></span></span>
