...
<span class="line"><span>    // 构造函数使用默认参数</span></span>
<span class="line"><span>    fn __init__(name, age=18, title=&quot;用户&quot;)</span></span>
...
<span class="line"><span>        print(&quot;我是&quot; + self.title + &quot; &quot; + self.name + &quot;，今年&quot; + str(self.age) + &quot;岁&quot;)</span></span>
<span class="line"><span>    end</span></span>
<span class="line"><span>end</span></span>
<span class="line"><span></span></span>
<span class="line"><span>// 使用默认参数创建对象</span></span>
<span class="line"><span>person1 = new Person(&quot;VLine&quot;)              // age使用默认值18，title使用默认值&quot;用户&quot;</span></span>
<span class="line"><span>person2 = new Person(&quot;VLine&quot;, 25)         // title使用默认值&quot;用户&quot;</span></span>
<span class="line"><span>person3 = new Person(&quot;VLine&quot;, 30, &quot;管理员&quot;) // 覆盖所有默认值</span></span>
<span class="line"><span></span></span>
<span class="line"><span>person1.introduce()  // 输出: 我是用户 VLine，今年18岁</span></span>
<span class="line"><span>person2.introduce()  // 输出: 我是用户 VLine，今年25岁</span></span>
<span class="line"><span>person3.introduce()  // 输出: 我是管理员 VLine，今年30岁</span></span></code></pre></div><h2 id="继承" tabindex="-1">继承 <a class="header-anchor" href="#继承" aria-label="Permalink to &quot;继承&quot;">​</a></h2><h3 id="基本继承" tabindex="-1">基本继承 <a class="header-anchor" href="#基本继承" aria-label="Permalink to &quot;基本继承&quot;">​</a></h3><div class="language-vline vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vline</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// 基类</span></span>
...
<span class="line"><span>    end</span></span>
<span class="line"><span>end</span></span></code></pre></div><h2 id="最佳实践" tabindex="-1">最佳实践 <a class="header-anchor" href="#最佳实践" aria-label="Permalink to &quot;最佳实践&quot;">​</a></h2><ol><li><p><strong>类设计</strong></p><ul><li>类名使用大写字母开头</li><li>一个类应该只有一个主要职责</li><li>保持类的接口简单明了</li></ul></li><li><p><strong>继承使用</strong></p><ul><li>避免过深的继承层次</li><li>优先使用组合而不是继承</li><li>正确重写父类方法</li></ul></li><li><p><strong>多态性</strong></p><ul><li>避免过度使用多态</li><li>保持方法签名一致</li></ul></li><li><p><strong>代码组织</strong></p><ul><li>相关的类放在一起</li><li>使用适当的注释</li><li>保持代码格式的一致性</li></ul></li></ol>`,22)]))}const f=s(l,[["render",i]]);export{h as __pageData,f as default};
